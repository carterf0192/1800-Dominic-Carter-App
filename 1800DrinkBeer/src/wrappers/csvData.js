...
export default function FetchCSVData(props) {
    ...
    const fetchCSVData = () => {
    const csvUrl = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vR0-x2-4z8hBEFwK6HJok2ymA-oWYNN3CRe1MZiUbPeGZ4Sh5UA6JvHS-E4cSjGYAhnb5CLu20YNPtc/pub?output=csv'; // Replace with your Google Sheets CSV file URL
